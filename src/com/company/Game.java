...
public class Game extends JPanel {
    ...
    private int numberOfShips[], indent, cellSize, numberOfPlayersShipsDestroyed, numberOFOpponentsShipsDestroyed, destroyedIndex, numberOfPlayer;
...
//                System.out.println("y " + y0 + " " + y + " " + y1);
    ...
    public void generatePlayersNumber(){
        numberOfPlayer = (int)(Math.random()*1000000000.0);
